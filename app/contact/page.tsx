  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0B0D10] text-[#E6E9EE]">
      ...
      <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
          ...
          alt=""
          aria-hidden="true"
          className="absolute left-0 top-[-52%] h-[190%] w-full object-cover object-[100%_18%] opacity-[0.36] scale-[1.18] md:top-[-30%] md:h-[160%] md:object-[100%_42%] md:opacity-[0.24]"
        />
      ...
      <div className="relative z-20">
                        <div className="pointer-events-none absolute right-0 top-0 z-[6] hidden h-[22rem] w-[26rem] bg-[linear-gradient(to_left,rgba(11,13,16,0.11)_0%,rgba(11,13,16,0.06)_28%,rgba(11,13,16,0.022)_54%,transparent_82%)] md:block" />
        ...
        <section className="relative overflow-hidden px-5 pb-16 pt-24 text-left md:px-0 md:pb-20 md:pt-32">
          <div className="relative md:ml-[11.625rem] md:max-w-[46rem]">
            ...
            >
              ...
              <p>We endeavor to read all emails, but cannot guarantee a response due to volume.</p>
