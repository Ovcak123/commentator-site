  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0B0D10] text-[#E6E9EE]">
      ...
      <div className="relative z-20">
        <div className="pointer-events-none absolute right-0 top-0 z-[6] hidden h-[22rem] w-[26rem] bg-[linear-gradient(to_left,rgba(11,13,16,0.11)_0%,rgba(11,13,16,0.06)_28%,rgba(11,13,16,0.022)_54%,transparent_82%)] opacity-50 md:block" />
