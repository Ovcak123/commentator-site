...
export default async function AboutPage() {
  ...
  return (
      ...
      <div className="relative z-20">
        ...
        <div className="pointer-events-none absolute inset-x-0 top-0 z-[5] h-[18rem] bg-[radial-gradient(circle_at_22%_16%,rgba(68,122,214,0.0125),transparent_34%),radial-gradient(circle_at_78%_18%,rgba(201,122,74,0.01),transparent_32%),linear-gradient(to_bottom,rgba(255,255,255,0.003)_0%,rgba(255,255,255,0.001)_20%,transparent_60%)] md:hidden" />
